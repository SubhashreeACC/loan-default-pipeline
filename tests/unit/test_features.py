...
def sample_raw_df():
    ...
    return pd.DataFrame({
        ...
        "name_education_type": ["Secondary / secondary special", "Higher education", "Secondary / secondary special"],
...
class TestCreditRatioTransformer:
    ...
    def test_zero_income_produces_nan(self):
        df = pd.DataFrame({"amt_income_total": [0.0], "amt_credit": [10000.0],
                           "amt_annuity": [500.0], "amt_goods_price": [9000.0],
                           "cnt_fam_members": [1.0]})
    ...
    def test_output_columns_present(self, sample_raw_df):
        ...
        for col in ["credit_income_ratio", "annuity_income_ratio",
                    "credit_term_months", "goods_credit_ratio",
